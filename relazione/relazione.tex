...
\newcommand\pythonstyle{\lstset{
	...
	language=Python,
	basicstyle=\linespread{1.8}\fontsize{8}{8}\ttfamily\color{white},
	morekeywords={self},
	keywordstyle=\linespread{1.8}\fontsize{8}{8}\ttfamily\color{deepblue},
	emph={MyClass,__init__},
	emphstyle=\linespread{1.8}\fontsize{8}{8}\ttfamily\color{codered},
	stringstyle=\linespread{1.8}\fontsize{8}{8}\ttfamily\color{deepgreen},
	commentstyle=\linespread{1.8}\fontsize{8}{8}\ttfamily\color{codelightblue},
	breaklines=true,
	frameround=ftff,
	frame=single,
...
\newcommand\swiftstyle{\lstset{
  ...
  language=swift,
  extendedchars=true,
  basicstyle=\linespread{2}\fontsize{8}{8}\ttfamily\color{white},
  keywordstyle=\linespread{2}\fontsize{8}{8}\ttfamily\color{keyword},
  stringstyle=\linespread{2}\fontsize{8}{8}\ttfamily\color{string},
  commentstyle=\linespread{2}\fontsize{8}{8}\ttfamily\color{comment},
  breaklines=true,
  frameround=ftff,
  frame=single,
  showspaces=false,
